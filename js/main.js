    ...
    <div class="problem-part">
      ...
      `<div>
        <h4 class="font-bold text-lg">Answer:</h4>
          ${part.answer ? `<p>${part.answer} = <span id="p${problemId}-${part.id}-answer" class="text-red-600 font-bold"></span></p>` : ` <p>-> <span id="p${problemId}-${part.id}-answer" class="text-red-600 font-bold"></span></p>`}
