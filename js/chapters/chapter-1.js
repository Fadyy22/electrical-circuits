document.getElementById('p1-a-submit').addEventListener('click', function (e) {
  e.preventDefault();
...
document.getElementById('p1-b-submit').addEventListener('click', function (e) {
  e.preventDefault();
...
document.getElementById('p2-a-submit').addEventListener('click', function (e) {
  e.preventDefault();
  const Vs = document.getElementById('p2-Vs').value;
  document.getElementById('p2-a-answer').innerHTML = `${(200 / 7) - ((10 * Vs) / 14)} V`;
});

document.getElementById('p2-b-submit').addEventListener('click', function (e) {
  e.preventDefault();
  const Vs = document.getElementById('p2-Vs').value;
...
document.getElementById('p3-a-submit').addEventListener('click', function (e) {
...
document.getElementById('p3-b-submit').addEventListener('click', function (e) {
  const Vg = document.getElementById('p3-Vg').value;
  const Rg = document.getElementById('p3-Rg').value;
  const Ra = document.getElementById('p3-Ra').value;
  const Rb = document.getElementById('p3-Rb').value;
...
document.getElementById('p3-c-submit').addEventListener('click', function (e) {
  const Vg = document.getElementById('p3-Vg').value;
  const Rg = document.getElementById('p3-Rg').value;
  const Ra = document.getElementById('p3-Ra').value;
  const Rb = document.getElementById('p3-Rb').value;
...
document.getElementById('p3-d-submit').addEventListener('click', function (e) { });

document.getElementById('p4-a-submit').addEventListener('click', function (e) {
  const Ia = document.getElementById('p4-Ia').value;
  document.getElementById('p4-a-answer').innerHTML = `${Ia * 4} A`;
});

document.getElementById('p4-b-submit').addEventListener('click', function (e) {
  const Ia = document.getElementById('p4-Ia').value;
  document.getElementById('p4-b-answer').innerHTML = `${Ia * 5} A`;
});

document.getElementById('p4-c-submit').addEventListener('click', function (e) {
  const Ia = document.getElementById('p4-Ia').value;
  document.getElementById('p4-c-answer').innerHTML = `${200 * (Ia * Ia)} W`;
});

document.getElementById('p5-a-submit').addEventListener('click', function (e) {
  const Vg = document.getElementById('p5-Vg').value;
  document.getElementById('p5-a-answer').innerHTML = `${0.0875 * Vg} A`;
});

document.getElementById('p5-b-submit').addEventListener('click', function (e) {
  const Vg = document.getElementById('p5-Vg').value;
  const Vg2 = Vg * Vg;
  document.getElementById('p5-b-answer').innerHTML = `${0.0325 * Vg2}, ${0.03125 * Vg2}, ${0.030625 * Vg2}, ${0.0125 * Vg2}, ${0.005625 * Vg2} W`;
});

document.getElementById('p5-c-submit').addEventListener('click', function (e) {
  const Vg = document.getElementById('p5-Vg').value;
  document.getElementById('p5-c-answer').innerHTML = `${0.1125 * (Vg * Vg)} V`;
});

document.getElementById('p6-a-submit').addEventListener('click', function (e) {
...
document.getElementById('p6-b-submit').addEventListener('click', function (e) {
  const Vg = document.getElementById('p6-Vg').value;
  const Vg2 = Vg * Vg;
  document.getElementById('p6-b-answer').innerHTML = `${(19 / 240) * Vg2} W`;
});

document.getElementById('p7-a-submit').addEventListener('click', function (e) {
...
document.getElementById('p7-b-submit').addEventListener('click', function (e) {
  const Ia = document.getElementById('p7-Ia').value;
  const Ib = document.getElementById('p7-Ib').value;
  const Va = document.getElementById('p7-Va').value;
  const Ib2 = Ib * Ib;
...
document.getElementById('p7-c-submit').addEventListener('click', function (e) {
  const Ia = document.getElementById('p7-Ia').value;
  const Ib = document.getElementById('p7-Ib').value;
  const Va = document.getElementById('p7-Va').value;
...
document.getElementById('p7-d-submit').addEventListener('click', function (e) {
  const Ia = document.getElementById('p7-Ia').value;
  const Ib = document.getElementById('p7-Ib').value;
  const Va = document.getElementById('p7-Va').value;
